...
module.exports = {
  ...
  // Max 50 simultaneous sessions in dev/prod. The test harness
  // (NODE_ENV === "test", set automatically by Jest) creates many more
  // sessions over a full run (~50 test files × multiple uploads).
  // Without a high cap in test mode, the 51st upload would return 503
  // and cascade into false failures.
  MAX_SESSIONS:
